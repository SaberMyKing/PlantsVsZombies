...
public class ConeheadZombie extends Zombie {
    ...
    public ConeheadZombie(Context context, RelativeLayout layout, int column)
    {
        ...
        mGifView[0].setMovieResource(R.drawable.conehead_zombie);
    ...
    {
        mGifViewObj.setMovieResource(R.drawable.conehead_zombie);
    }

    public void attackAction()
    {
        mGifViewObj.setMovieResource(R.drawable.conehead_zombie_attack);
    }
