...
public class EasyZombie extends Zombie{
    ...
    public EasyZombie(Context context, RelativeLayout layout, int column)
    {
        ...
        mGifView[0].setMovieResource(R.drawable.zombie);
    ...
    {
        mGifViewObj.setMovieResource(R.drawable.zombie);
    }

    public void attackAction()
    {
        mGifViewObj.setMovieResource(R.drawable.zombie_attack);
    }
